...
//the padding for the texts at the y-axis and x-axis
var tPadBot = 40;
var tPadLeft = 40;
...
//radius for each dot on the graph 
  var circRadius;
...
function visualize(theData) {
  ...
  // changing the classes (and appearance) of label text when clicked
  ...
  // adding the first placement of our data and axis to the scatter plot
  xMinMax();
  yMinMax();
  ...
  // grouping our dots and their labels.
